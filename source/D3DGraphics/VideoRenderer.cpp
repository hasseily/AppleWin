...
VideoRenderer::VideoRenderer() noexcept(false)
{
    /*
...
// Updates the world.
void VideoRenderer::Update(DX::StepTimer const&)
{
    ...
    // assuming we have a way to show the user that they're in the focus of the video screen
    if (kb.Escape)
    {
...
// Message handlers
void VideoRenderer::OnActivated()
{
}

void VideoRenderer::OnDeactivated()
{
}

void VideoRenderer::OnSuspending()
{
}

void VideoRenderer::OnResuming()
{
    m_timer.ResetElapsedTime();
}

void VideoRenderer::OnWindowSizeChanged(int width, int height)
{
...
void VideoRenderer::OnDeviceLost()
{
    m_texture.Reset();
    m_indexBuffer.Reset();
...
void VideoRenderer::OnDeviceRestored()
{
    CreateDeviceDependentResources();
